...
components/
  ...
  ui/               Shadcn primitives (button, input, label) + DrawerPickers.tsx (CalendarPicker/MonthPicker/CategoryList/SourceList — rendered inside BottomDrawer app-wide) + PushPage.tsx / ListRow.tsx (the full-screen page shell and its rows)
