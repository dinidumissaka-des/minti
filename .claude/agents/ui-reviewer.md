...
- Surface cards (components/Surface.tsx, formerly GlassSurface) with borderRadius=28 are the standard container; it paints an opaque --surface, so flag any card that reintroduces a frost or backdrop-filter
