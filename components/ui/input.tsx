...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "h-[52px] w-full rounded-xl border border-ink/10 bg-ink/5 backdrop-blur-md px-4 py-2 text-base text-ink placeholder:text-muted transition-colors outline-none",
